...
/**
 * <p>Classe Java de ObterPessoasContratosCompletoType complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conte�do esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="ObterPessoasContratosCompletoType">
 *   &lt;complexContent>
...
@XmlType(name = "ObterPessoasContratosCompletoType", propOrder = {
    "numeroCpfouCnpj",
    "numeroOrdemCnpj",
    "digitoCpfouCnpj",
...
public class ObterPessoasContratosCompletoType {
    ...
    protected List<ObterPessoasContratosCompletoType.FiltroContrato> filtroContrato;
    protected List<ObterPessoasContratosCompletoType.Suseps> suseps;
     ...
     * {@link ObterPessoasContratosCompletoType.FiltroContrato }
     * 
     * 
     */
    public List<ObterPessoasContratosCompletoType.FiltroContrato> getFiltroContrato() {
        if (filtroContrato == null) {
            filtroContrato = new ArrayList<ObterPessoasContratosCompletoType.FiltroContrato>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ObterPessoasContratosCompletoType.Suseps }
     * 
     * 
     */
    public List<ObterPessoasContratosCompletoType.Suseps> getSuseps() {
        if (suseps == null) {
            suseps = new ArrayList<ObterPessoasContratosCompletoType.Suseps>();
        }
        return this.suseps;
    }
    ...
    public static class FiltroContrato {
        ...
        protected List<ObterPessoasContratosCompletoType.FiltroContrato.ChaveDocumento> chaveDocumento;
        protected ObterPessoasContratosCompletoType.FiltroContrato.Produto produto;
        ...
        protected List<ObterPessoasContratosCompletoType.FiltroContrato.PeriodoDataEmissao> periodoDataEmissao;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ObterPessoasContratosCompletoType.FiltroContrato.ChaveDocumento }
         * 
         * 
         */
        public List<ObterPessoasContratosCompletoType.FiltroContrato.ChaveDocumento> getChaveDocumento() {
            if (chaveDocumento == null) {
                chaveDocumento = new ArrayList<ObterPessoasContratosCompletoType.FiltroContrato.ChaveDocumento>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ObterPessoasContratosCompletoType.FiltroContrato.Produto }
         *     
         */
        public ObterPessoasContratosCompletoType.FiltroContrato.Produto getProduto() {
            return produto;
        }
         ...
         *     
         */
        public void setProduto(ObterPessoasContratosCompletoType.FiltroContrato.Produto value) {
            this.produto = value;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ObterPessoasContratosCompletoType.FiltroContrato.PeriodoDataEmissao }
         * 
         * 
         */
        public List<ObterPessoasContratosCompletoType.FiltroContrato.PeriodoDataEmissao> getPeriodoDataEmissao() {
            if (periodoDataEmissao == null) {
                periodoDataEmissao = new ArrayList<ObterPessoasContratosCompletoType.FiltroContrato.PeriodoDataEmissao>();
            }
        ...
        public static class Produto {
            ...
            protected List<ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto> listaProduto;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto }
             * 
             * 
             */
            public List<ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto> getListaProduto() {
                if (listaProduto == null) {
                    listaProduto = new ArrayList<ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto>();
                }
            ...
            public static class ListaProduto {
                ...
                protected List<ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto.ListaSegmento> listaSegmento;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto.ListaSegmento }
                 * 
                 * 
                 */
                public List<ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto.ListaSegmento> getListaSegmento() {
                    if (listaSegmento == null) {
                        listaSegmento = new ArrayList<ObterPessoasContratosCompletoType.FiltroContrato.Produto.ListaProduto.ListaSegmento>();
                    }
