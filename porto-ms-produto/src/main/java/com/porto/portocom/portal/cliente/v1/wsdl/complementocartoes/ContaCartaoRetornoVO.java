...
/**
 * <p>Java class for contaCartaoRetornoVO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="contaCartaoRetornoVO">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="codigoRetorno" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="contasVOs" type="{http://ws.cartaoweb.cartoes.financeiro.com/}contaVO" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "contaCartaoRetornoVO", propOrder = {
    "codigoRetorno",
    "contasVOs",
    "mensagemRetorno",
    "nome",
...
@XmlSeeAlso({
    ContaCartaoComEmailRetornoVO.class
})
public class ContaCartaoRetornoVO implements Serializable {

	private static final long serialVersionUID = 2692480617732915077L;

	protected Integer codigoRetorno;
    @XmlElement(nillable = true)
    protected List<ContaVO> contasVOs;
     ...
     * 
     */
    public List<ContaVO> getContasVOs() {
        if (contasVOs == null) {
            contasVOs = new ArrayList<ContaVO>();
        }
